...
(1, 'Điện thoại', 'fas fa-mobile-alt'),
(2, 'Laptop', 'fas fa-laptop'),
(3, 'Tai nghe & Loa', 'fas fa-headphones'),
(4, 'Chuột & Bàn phím', 'fas fa-keyboard');
...
-- (7, 'REDNOTE', 'Redmi Note 13 Pro 4G', 1, 5500000.00, 30, 'Cấu hình ngon bổ rẻ cho sinh viên', 'redmi13.jpg', 1),
...
-- (11, 'MACM3', 'MacBook Air M3 2024', 2, 28000000.00, 8, 'Laptop mỏng nhẹ, hiệu năng cao', 'macbookm3.jpg', 1),
-- (12, 'ASUSTF', 'ASUS TUF Gaming A15', 2, 21500000.00, 11, 'Laptop gaming quốc dân bền bỉ', 'asustuf.jpg', 1),
-- (13, 'DELLVO', 'Dell Vostro 3430 Core i5', 2, 14000000.00, 15, 'Laptop văn phòng gọn nhẹ lịch lãm', 'dell3430.jpg', 1),
...
-- (16, 'ACERNI', 'Acer Nitro V 2024', 2, 19900000.00, 14, 'Tản nhiệt mát mẻ chiến game mượt', 'acernitro.jpg', 1),
-- (17, 'MSICYG', 'MSI Cyborg 15 Độc Đáo', 2, 17500000.00, 10, 'Thiết kế bán trong suốt đậm chất cyber', 'msicyborg.jpg', 1),
...
-- (21, 'APPRO2', 'AirPods Pro Gen 2', 3, 5500000.00, 30, 'Tai nghe chống ồn chủ động đỉnh cao', 'airpods.jpg', 1),
-- (22, 'SONWH1', 'Sony WH-1000XM5 Premium', 3, 6900000.00, 10, 'Tai nghe chụp tai chống ồn tốt nhất', 'sony_wh.jpg', 1),
-- (23, 'MARCH4', 'Marshall Major IV Cổ Điển', 3, 3600000.00, 15, 'Pin trâu 80 tiếng, thiết kế hoài cổ', 'marshall4.jpg', 1),
-- (24, 'JBLCH5', 'Loa Bluetooth JBL Charge 5', 3, 3400000.00, 25, 'Chống nước IP67, âm bass mạnh mẽ', 'jbl_charge5.jpg', 1),
-- (25, 'ANKS30', 'Soundcore Anker Space A40', 3, 1600000.00, 40, 'Tai nghe ngon bổ rẻ chống ồn tốt', 'anker_a40.jpg', 1),
-- (26, 'SONWF1', 'Sony WF-C500 Nhỏ Gọn', 3, 1200000.00, 50, 'Nhiều màu sắc, âm thanh trong trẻo', 'sony_c500.jpg', 1),
-- (27, 'MARGO3', 'Loa Marshall Willen Siêu Nhỏ', 3, 2500000.00, 18, 'Loa di động bỏ túi âm thanh chất', 'willen.jpg', 1),
